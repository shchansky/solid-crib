...
// ❌ НАРУШЕНИЕ SRP: Класс с множественными ответственностями. Класс знает о всех типах фигур и делает всё для них
class ShapeProcessor {
    ...
    // ❌ ПРОБЛЕМА: Невозможно легко добавить новую фигуру. Для добавления Triangle нужно изменить весь класс.
    // processTriangle() {
...
// 💡 ЧТО НЕ ТАК: Один класс пытается обработать все типы фигур
