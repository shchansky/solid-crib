...
// 💡 ЧТО НЕ ТАК: Каждый класс реализует свои методы без общего контракта. Нет общего интерфейса - детали не зависят от абстракций
class Circle {
...
// ❌ НАРУШЕНИЕ DIP: Класс зависит от конкретных реализаций. Высокоуровневый модуль зависит от низкоуровневых
// 💡 ЧТО НЕ ТАК:
...
class ShapeCalculator {
  ...
  // 💡 ЧТО НЕ ТАК: Высокоуровневый модуль зависит от низкоуровневых
  ...
  constructor({
    ...
    // ❌ НАРУШЕНИЕ DIP: Создание конкретных зависимостей внутри класса. Высокоуровневый модуль создает низкоуровневые модули и зависит от них
