...
class BadShapeCalculator {
    ...
    constructor({circledata : {radius}, rectangledata : {width, height}} : ShapeData) {
        ...
        // 🎯 РЕШЕНИЕ: Зависимости должны передаваться извне через конструктор
    ...
    // 💡 ЧТО НЕ ТАК: Для добавления Triangle нужно изменить этот класс
...
function demonstrateTestingProblems() {
    const calculator = new BadShapeCalculator({
        circledata: { radius: 5 },
