...
// 🔧 РЕШЕНИЕ: Разделить на несколько специализированных типов
type Shape = {
...
// 💡 ЧТО НЕ ТАК: Circle должен реализовывать методы, которые ему не нужны
...
// ❌ НАРУШЕНИЕ ISP: Фабричные функции создают объекты с ненужными методами
// 💡 ЧТО НЕ ТАК: Rectangle должен реализовывать методы, которые ему не нужны
// 🎯 РЕЗУЛЬТАТ: Возвращает бессмысленные значения
